const Footer = () => {
    return (
        <footer className="relative bg-[#13172b] text-white py-8 md:py-16 mt-8 md:mt-[257px] px-4 md:px-8 w-full">
            ...
            {/* Footer Logo */}
            <div className="flex justify-center items-center mt-44 md:mt-24">
                <img src="/assets/logo-footer.png" alt="Footer Logo" className="w-24 h-auto" />
            </div>

            {/* Main footer content */}
            <div className="flex flex-col md:flex-row justify-between items-start text-center md:text-left mt-16 md:mt-24 space-y-8 md:space-y-0 px-4 md:px-0 w-full">
