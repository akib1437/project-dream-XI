...
const Navbar = ({ credit = 0 }) => {
    ...
    return (
        <nav className="flex justify-between items-center border-b py-4 px-6 w-5/6 mx-auto">

            <div className="container mx-auto flex justify-between items-center">
                <div className="flex items-center">
                    <img className="w-12 h-auto" src="/dist/assets/logo.png" alt="" />
                </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
                ...
                <button className="flex items-center bg-white border border-gray-300 px-4 py-2 rounded-lg font-semibold text-gray-800 hover:bg-gray-100 whitespace-nowrap">
                    <span className='mr-2'>{credit} Coin</span> <RiCoinsLine className="text-yellow-400 text-2xl" />
                </button>
            </div>
            ...
            {isOpen && (
                <div className="md:hidden mt-4">
                    <ul className="flex flex-col items-center space-y-4 menu menu-sm dropdown-content bg-white rounded-lg z-[1] mt-2 p-1 shadow">
                        ...
                        <li>
                            <button className="flex items-center bg-gray-100 border border-gray-300 text-gray-700 font-semibold py-2 px-4 rounded-md hover:bg-gray-200 whitespace-nowrap">{credit} Coin <span className="ml-2"><RiCoinsLine className="text-yellow-400 text-2xl" /></span></button>
                        </li>
                    </ul>
                </div>
            )      
